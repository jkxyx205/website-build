 ...
 */
public class PicArticleHTMLEditor extends AbstractHTMLEditor {
    public static final Integer CONTENT_TYPE = 502;

    public static final String DESCRIPTION = "左图右文";

    private static final PicArticleHTMLEditor htmlEditor = new PicArticleHTMLEditor(CONTENT_TYPE, DESCRIPTION);

    protected PicArticleHTMLEditor(Integer contentType, String description) {
    ...
    public static PicArticleHTMLEditor getInstance() {
        return htmlEditor;
    }
