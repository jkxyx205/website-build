...
<div class="form form-setting" id="form">
    ...
    <div class="item-group">
        ...
        <div class="item-group" style="margin-top: 12px;">
            ...
            <div class="item-control inner-box" style="width: 430px;">
        ...
        <div class="item-tab">
            ...
            <div class="item-tab-content" id="a">
                <%--<div class="image-list">--%>
                    <%--<div class="image-box"  v-for="item in components" :class="{active: item.id == activeId}" @click="activeId = item.id" :title="item.title">--%>
                            <%--<div :class='"component-img-container component-img-" + item.id'>--%>
                            <%--</div>--%>
                    <%--</div>--%>
                <%--</div>--%>
...
<%--<script src="/static/plugins/column-selector/jquery-column-selector.js"></script>--%>
<%--<script src="/static/plugins/noUiSlider/nouislider.min.js"></script>--%>
<%--<script src="/static/plugins/wNumb.js"></script>--%>
<script>
