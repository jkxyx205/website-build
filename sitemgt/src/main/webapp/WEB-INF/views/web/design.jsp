...
<head>
    <link rel="stylesheet" href="${applicationScope.fileServer}/static/plugins/Swiper-4.0.5/css/swiper.min.css">
    <link rel="stylesheet" href="${applicationScope.fileServer}/static/plugins/switchButton/ui.switchbutton.min.css">
...
<div id="inner-page" class="inner-page">
        ...
        <ul class="design-bar-left btn-operator">
            ...
            <li>
                <%--<a href="javascript:;"  style="width: 80px;"><label style="margin-bottom: 0;"><span style="color: #fff; margin-right: 5px;">预览模式</span><input id="status" type="checkbox"></label></a>--%>
                    <input type="checkbox" class="common" id="status" checked="checked" />
            </li>
    ...
    <div class="design-container" id="design-container">
            <iframe id="iframe" name="iframe" src="/web/${webId}/design/page/${pageName}#${pageComponentId}" frameborder="0"></iframe>
    </div>
</div>
</body>
...
<myfooter>
    ...
    <script src="${applicationScope.fileServer}/static/plugins/switchButton/jquery.tmpl.min.js"></script>
    <script src="${applicationScope.fileServer}/static/plugins/jquery-ui/jquery-ui.js"></script>
    <script src="${applicationScope.fileServer}/static/plugins/switchButton/jquery.switchbutton.min.js"></script>
