...
abstract class NamedParameterUtils {
	 ...
	 * {@link #substituteNamedParameters(ParsedSql, org.springframework.jdbc.core.namedparam.SqlParameterSource)}.
	 * @param sql the SQL statement
	 ...
	 * Convert a Map of named parameter values to a corresponding array.
	 * <p>This is a shortcut version of
	 * {@link #buildValueArray(ParsedSql, org.springframework.jdbc.core.namedparam.SqlParameterSource, java.util.List)}.
	 * @param sql the SQL statement
